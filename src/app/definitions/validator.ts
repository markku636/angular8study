...
export const ValidIP: ValidatorFn = (control: AbstractControl): { [key: string]: boolean } => {
...
export const ValidUrl: ValidatorFn = (control: AbstractControl): { [key: string]: boolean } => {
